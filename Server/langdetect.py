...
# detect language, return language code, if lang1 and lang2 are specifed,
# return the most confident one
def langdetect(audio, lang_code1 = None, lang_code2 = None):
...
if __name__ == "__main__":
    ...
    langdetect("Server/audio/chinese.mp3", 'zh', 'ja') # warm up
    ...
    for i in range(10):
        s = time.time()
        lang = langdetect("Server/audio/chinese.mp3", 'zh', 'ja')
